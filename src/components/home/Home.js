        ...
        <div className={styles.container}>
            <div className={styles.artworkColumnLeft}>
                <div className={styles.artworkCard}>
                    <img src={BoxerAtRest} alt="Boxer At Rest" className={styles.artworkImage} />  
                </div>
                <div className={styles.artworkCard}>
                    <img src={Angel} alt="Angel Statue" className={styles.artworkImage} />           
                </div>
                <div className={styles.artworkCard}>
                    <img src={TheRaft} alt="The Raft" className={styles.artworkImage} />
                </div>
            </div>
            ...
            <div className={styles.artworkColumnRight}>
                <div className={styles.artworkCard}>
                    <img src={StarryNight} alt="Starry Night" className={styles.artworkImage} />
                </div>
                <div className={styles.artworkCard}>
                    <img src={LastSupper} alt="The Last Supper" className={styles.artworkImage} />
                </div>
                <div className={styles.artworkCard}>
                    <img src={TheScream} alt="The Scream" className={styles.artworkImage} />
                </div>
            </div>
        </div>
    );
